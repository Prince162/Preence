    ...
    try:
        for pw in pwx:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ui = uid.replace("\n", "")
                print("\033[92m[ Prince-OK ] : "+ui+"  |  "+pw+"\033[37m")
                ...
                ui = uid.replace("\n", "")
                print("\033[91m[ Prince-CP ] : "+ui+"  |  "+pw+"\033[37m")
